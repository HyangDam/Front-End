    ...
    <div className="flex items-center gap-3 border-b border-border py-3 last:border-b-0">
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <p className="mb-[3px] truncate font-mono text-[8px] uppercase tracking-[1.2px] text-muted">
            {perfume.brand}
          </p>
          <p className="mb-[3px] truncate font-serif text-[13px] text-charcoal">
            {perfume.name}
          </p>
          {perfume.notes && (
            <p className="truncate font-sans text-[11px] text-muted">{perfume.notes}</p>
          )}
        </div>
      </Link>
      <button
