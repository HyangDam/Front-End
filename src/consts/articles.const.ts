...
export const ARTICLES: ArticleT[] = [
  {
    ...
    ctaHref: "/search?category=citrus",
  },
  {
    id: 2,
    tag: "SEASONAL",
    eyebrow: "가을 산책길",
    title: "가을에 어울리는\n우디 플로럴 향수 TOP 5",
    img: "https://images.unsplash.com/photo-1507290439931-a861b5a38200?w=700&q=80&auto=format&fit=crop",
    ...
    ctaHref: "/search?category=woody,floral",
  },
  {
    id: 3,
    tag: "GUIDE",
